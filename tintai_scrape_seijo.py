...
#URL（東京都成城学園前の賃貸住宅情報 検索結果の1ページ目）
url = 'https://suumo.jp/jj/chintai/ichiran/FR301FC001/?ar=030&bs=040&ra=013&cb=0.0&ct=9999999&et=9999999&cn=9999999&mb=0&mt=9999999&shkr1=03&shkr2=03&shkr3=03&shkr4=03&fw2=&ek=024020990&rn=0240'
...
#csvファイルとして保存
suumo_df.to_csv('suumo_seijo.csv', sep = '\t',encoding='utf-16')